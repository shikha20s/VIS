...
function validate()
{
	if(requiredFieldValidation('email','namerror','enter registration number first')=="fail"){}
	else{
		window.open('getcerti.jsp','_self');
	}
</script>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" id="inputregister" placeholder="Email" name="name" required="ture">
...
<div class="mdl-layout__drawer">
    ...
    <div class="nav-wrapper teal accent-2 black-text text-darken-2">
       <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><button type="button" class="btn btn-info btn-lg" id="registration" onclick="fun()">Registration</button></li>
         <li><button type="button" class="btn btn-info btn-lg" id="tranfer" onclick="fun1()">Transfer</button></li>
                    <li><button type="button" class="btn btn-info btn-lg" id="logut"onclick="fun2()">Logout</button></li>
